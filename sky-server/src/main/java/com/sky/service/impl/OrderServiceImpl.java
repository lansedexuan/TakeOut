...
/*        JSONObject jsonObject = weChatPayUtil.pay(
        ...
        // 发现没有将支付时间 check_out_time 属性赋值，所以在这里更新
        ...
        //通过websocket通知客户端浏览器 type orderId content
        Orders orders=orderMapper.getByNumberAndUserId(orderNumber, userId);
        Map map = new HashMap();
        map.put("type", 1);//1表示来单 2表示客户催单
...
/*            //调用微信支付退款接口
    ...
    public OrderStatisticsVO statistics() {
        ...
        //将查询到的数量封装到orderStatisticsVO中响应
...
/*            //用户已支付，需要退款
     ...
     */
    @Override
    public void complete(Long id) {        //根据id查询订单
        Orders ordersDB = orderMapper.getById(id);
